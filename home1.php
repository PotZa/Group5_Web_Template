...
-->
    ...
    <body>
      <form id="form1" method="post" action="register_add.php">
        <!--[if lt IE 8]>
                  ...
                  <div class="col-md-8 col-md-offset-2">
                    <div class="home-content">
                      <div class="home-heading">
                            <h1 align = 'center'><em> &nbsp; WINEKRUB</em> &nbsp;<hr width="80%" size="10px" color="red"><p> Home <br> Welcome <?=$_POST['uname2']?></h1>
                        </div>
                      <div class="row">
                        <div class="col-md-12" align = "left">
                          <div class="home-box-content">
                                <div class="left-text">
                                        <h4>New <em>Agera R</em> เเรงขึ้นกว่าเดิม</h4>
                                        <div class="primary-button">
                                            <a href="http://www.koenigsegg.com/agera-r/">Watch it</a>
                                        </div>
                                    </div>
                                    <div class="right-image">
                                        <img src="img/AgeraR.jpg" width="150px"; height="150px";>
                                    </div>
                                </div>
